// RA: I've duplicated the setup for jQuery here because recurring-select relies on it
import "jquery"
import "jquery-ujs"
...
// RA:
// ORIGINALLY /recurring-select/dist/index.js from: https://www.npmjs.com/package/recurring-select?activeTab=code
// ARCHIVED: https://web.archive.org/web/20230410205356/https://www.npmjs.com/package/recurring-select?activeTab=code
// NPM listing refers to a repo that is no longer available: https://github.com/KatanaCode/recurring-select
// Everything from here down is a copy of index.js except where the controller is instantiated at the bottom
...
import RecurringSelectDialog from "../lib/recurring_select/recurring_select_dialog";
...
export default class extends Controller {
    connect() {
        // RA: I left the default console log in place to show that the code is running
        console.log("EditEventController connected")
    }
}